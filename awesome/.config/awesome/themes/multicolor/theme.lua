...
local colors = {
	bg = "#FFF7FC", -- F9F5F6
	normal = "#9F9C9C", --c7c4c4
	focus = "#FF71CD", --FDCEDF
	urgent = "#8B93FF", --F2BED1
	minimize = "#000000", --000000
	border = {
		normal = "#c7c4c4",
		focus = "#606060",
		marked = "#5755FE",
...
theme.fg_focus = colors.focus
theme.fg_urgent = colors.urgent
theme.fg_minimize = colors.minimize
theme.border_width = dpi(1)
theme.border_normal = colors.border.normal
theme.border_focus = colors.border.focus
theme.border_marked = colors.border.marked
theme.menu_border_width = 0
theme.menu_width = dpi(130)
theme.menu_submenu_icon = theme.confdir .. "/icons/submenu.png"
theme.menu_fg_normal = colors.normal
theme.menu_fg_focus = colors.focus
theme.menu_bg_normal = colors.bg
theme.menu_bg_focus = colors.border.marked
...
theme.weather = lain.widget.weather({
	current_call = "https://api.openweathermap.org/data/2.5/weather?id=%s&appid=%s",
	city_id = 311728, -- mersin
	APPID = "acf08ad6c9424ebb6fd8447f703ded81",
